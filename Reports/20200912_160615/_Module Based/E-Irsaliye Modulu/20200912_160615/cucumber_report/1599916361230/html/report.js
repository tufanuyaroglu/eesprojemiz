$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/e-Irsaliye/Gelen Kutusu/Irsaliyeler/Departman Geri Al.feature");
formatter.feature({
  "name": "Irsaliyenin departmanini geri al",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "VirgosolDepartman isimli departman checkboxı seçilir",
  "keyword": "* "
});
formatter.match({
