$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/e-Irsaliye/Gelen Kutusu/Irsaliyeler/PDF Indir.feature");
formatter.feature({
  "name": "Irsaliyenin PDFinin indirilmesi",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Ön eki DespatchAdvice olan dosya indirildi mi",
  "keyword": "* "
});
formatter.step({
