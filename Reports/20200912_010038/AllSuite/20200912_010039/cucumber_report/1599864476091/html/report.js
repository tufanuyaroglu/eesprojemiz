$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/Zarflar/Giden Zarflar/Tablodaki Verinin Irsaliyeleri.feature");
formatter.feature({
  "name": "Giden Zarf Tablodaki Verinin Irsaliyeleri",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Tablodaki \u003cveri_Adi\u003e isimli verinin İrsaliyeler adlı butonuna tıklanır",
  "keyword": "* "
});
formatter.step({
  ...
  "rows": [
    ...
    },
    {
      "cells": [
        "01.01.2020",
        "31.01.2020",
        "Gelir İdaresi Başkanlığı e-İrsaliye Sanal Alıcı"
      ]
    }
  ]
});
...
formatter.step({
  "name": "Tablodaki Gelir İdaresi Başkanlığı e-İrsaliye Sanal Alıcı isimli verinin İrsaliyeler adlı butonuna tıklanır",
  "keyword": "* "
});
formatter.match({
