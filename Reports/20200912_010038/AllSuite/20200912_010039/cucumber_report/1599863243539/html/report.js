$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/e-Irsaliye/Giden Kutusu/Irsaliye Yanitlari/Filtre Kontrolu.feature");
formatter.feature({
  "name": "Giden Kutusu Irsalie Yanitlari Filtre Kontrolu",
  "description": "",
  "keyword": "Feature"
});
formatter.scenarioOutline({
  "name": "Giden Kutusu Irsaliye Yanitlari Filtre Kontrolu",
  "description": "",
...
formatter.step({
  "name": "Alt menü Giden Kutusu başlığı altındaki İrsaliye Yanıtları seçilir",
  "keyword": "* "
});
formatter.step({
  "name": "Filtre alanlarında Gönderici Ünvanı var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Filtre alanlarında Alıcı VKN/TCKN var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Filtre alanlarında İrsaliye Yanıtı No var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Filtre alanlarında İrsaliye Yanıtı ETTN var mı",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Filtre alanlarında Belge Tarihi var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Filtre alanlarında İlşk. İrsaliye No var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Filtre alanlarında İlşk. İrsaliye ETTN var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Filtre alanlarında Zarf Durumu var mı",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Filtre alanlarında Zarf ETTN var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Filtre alanlarında Atanan Departman var mı",
  "keyword": "* "
});
formatter.step({
