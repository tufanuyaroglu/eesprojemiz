$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/Regresyon/e-Serbest Meslek Makbuzu/VKN-e-Serbest Meslek Makbuzu-Kagit Excel Aktar.feature");
formatter.feature({
  "name": "VKN ile e-Serbest Meslek Makbuzu Olusturulmasi ve Excele aktarilmasi",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Tasarım alanından e-Serbest Meslek Makbuz Öndeğer Şablon Tasarım seçilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Ürün ekleme alanında Ücretin Ne İçin Alındığı başlığına \u003curun_Adi\u003e girilir",
  "keyword": "* "
});
formatter.step({
  "name": "Ürün ekleme alanında Brüt Ücret başlığına \u003cbrut\u003e girilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Filtrelerden Alıcı Unvan filtresine \u003cunvan\u003e textini yaz",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Ön eki SerbestMeslekMakbuzlari olan dosya indirildi mi",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Filtrelerden Alıcı Unvan filtresine VirgosolOtomasyon textini yaz",
  "keyword": "* "
});
formatter.match({
