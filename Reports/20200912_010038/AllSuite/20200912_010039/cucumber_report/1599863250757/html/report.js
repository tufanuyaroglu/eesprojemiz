$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/e-Irsaliye/Giden Kutusu/Irsaliye Yanitlari/Gecmis.feature");
formatter.feature({
...
formatter.step({
  "name": "İrsaliye Yanıtları Geçmişi baslikli gecmis sayfasi geldi mi",
  "keyword": "* "
});
formatter.match({
