$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/e-Makbuz/e-Serbest Meslek Uygulaması/e-Serbest Meslek Makbuzlari/Iptal Geri Al.feature");
formatter.feature({
  "name": "e-Serbest Meslek Makbuzlari Iptal Geri Al",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Butonlardan İptal Geri Al isimli butona tıklanır",
  "keyword": "* "
});
formatter.step({
  "name": "Popup mesajı Seçilen makbuzlar için iptal işlemi geri alınacaktır onaylıyor musunuz içeriyor mu",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Popup mesajı İptal Edildi durumunda olan ve raporlanmayan 1 adet belge için iptal işlemi geri alınmıştır içeriyor mu",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Tablodan wwww isimli veri seçilir",
  "keyword": "* "
});
formatter.match({
