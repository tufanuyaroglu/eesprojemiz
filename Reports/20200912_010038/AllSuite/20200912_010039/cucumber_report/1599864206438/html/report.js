$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/Regresyon/e-Fatura/VKN-Kamu-Tevkifat Excele Aktar.feature");
formatter.feature({
  "name": "VKNo ile Kamu senaryosunda ve Tevkifat tipinde fatura olusturulmasi ve Excele aktarilmasi",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Alt menü e-Fatura Araçları başlığı altındaki e-Fatura Oluşturma seçilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Görsel tasarım sayfasının e-Fatura Bilgileri başlığını içerdiği kontrol edilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Senaryo alanından Kamu seçilir",
  "keyword": "* "
});
formatter.step({
  "name": "Tip alanından Tevkifat seçilir",
  "keyword": "* "
});
formatter.step({
  "name": "Döküman Para Birimi alanından Türk Lirası seçilir",
  "keyword": "* "
});
formatter.step({
  "name": "Ön Ek ZZZ olarak seçilir",
  "keyword": "* "
});
formatter.step({
  "name": "Tasarım alanından Mavi Temali e-Fatura Öndeger Sablon Tasarim.xslt- seçilir",
  "keyword": "* "
});
formatter.step({
  "name": "Sipariş bilgileri UUC-SAT-1200001 ve 31.04.2020 olarak girilir",
  "keyword": "* "
});
formatter.step({
  "name": "İrsaliye Bilgileri AAAAAAAAAA,31.04.2020 olarak girilir",
  "keyword": "* "
});
formatter.step({
  "name": "Ödeme Bilgileri 11111111111,Türk Lirası olarak girilir",
  "keyword": "* "
});
formatter.step({
  "name": "Ek Bilgiler Gönderen,ABONENO,2000 olarak girilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Ürün ekleme alanında İskonto Oranı % başlığına 10 girilir",
  "keyword": "* "
});
formatter.step({
  "name": "Ürün ekleme alanında KDV Oranı % başlığına 18 girilir",
  "keyword": "* "
});
formatter.step({
  "name": "Ürün ekleme alanında KDV İstisna Muafiyet Kodu başlığına 351  KDV - İstisna Olmayan Diğer girilir",
  "keyword": "* "
});
formatter.step({
  "name": "Ürün ekleme alanında GTIP Kodu başlığına 88.01.00.90.00.00 girilir",
  "keyword": "* "
});
formatter.step({
  "name": "Ürün ekleme alanında KDV TEVKİFAT Oranı % başlığına 12 girilir",
  "keyword": "* "
});
formatter.step({
  "name": "Ürün ekleme alanında KDV TEVKİFAT Kodu başlığına 604 - YEMEK SERVİS HİZMETİ girilir",
  "keyword": "* "
});
formatter.step({
  "name": "Ürün ekleme alanında CPA Kodu başlığına 55555 girilir",
  "keyword": "* "
});
formatter.step({
  "name": "Ürün ekleme alanında Menşei başlığına Türkiye girilir",
  "keyword": "* "
});
formatter.step({
  "name": "KDV Muafiyet Bilgileri 351 KDV - İstisna Olmayan Diğer olarak girilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Tablodan \u003cunvan\u003e isimli veri seçilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Butonlardan Onayla isimli butona tıklanır",
  "keyword": "* "
});
formatter.step({
  "name": "Popup mesajı Devam etmek istiyor musunuz içeriyor mu",
...
formatter.step({
  "name": "Filtrelerden Alıcı Ünvan filtresine \u003cunvan\u003e textini yaz",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Alt butonlardan Excel\u0027e Aktar butonuna tıklanır",
  "keyword": "* "
});
formatter.step({
  "name": "Ön eki E-Fatura olan dosya indirildi mi",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Alıcı adı alanına VirgosolFaturaVKN girilir",
  "keyword": "* "
});
formatter.match({
...
formatter.match({
  "location": "genel.turSecilir(String)"
});
formatter.result({
  "status": "skipped"
});
...
formatter.match({
  "location": "genel.dokumanParaBirimindenSecilir(String)"
});
formatter.result({
  "status": "skipped"
});
...
formatter.match({
  "location": "genel.onEkSecilir(String)"
});
formatter.result({
  "status": "skipped"
});
...
formatter.match({
  "location": "genel.tasarimSecilir(String)"
});
formatter.result({
  "status": "skipped"
});
...
formatter.match({
  "location": "genel.siparisBilgileri(String,String)"
});
formatter.result({
  "status": "skipped"
});
...
formatter.match({
  "location": "genel.irsaliyeBilgileriGirilir(String,String)"
});
formatter.result({
  "status": "skipped"
});
...
formatter.match({
  "location": "genel.odemeBilgileriIbanDoviz(String,String)"
});
formatter.result({
  "status": "skipped"
});
...
formatter.match({
  "location": "genel.ekBilgilerGirilir(String,String,String)"
});
formatter.result({
  "status": "skipped"
});
...
formatter.match({
  "location": "genel.kdvMuafiyetBilgileri(String)"
});
formatter.result({
  "status": "skipped"
});
...
formatter.step({
  "name": "Tablodan VirgosolOtomasyon isimli veri seçilir",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Filtrelerden Alıcı Ünvan filtresine VirgosolOtomasyon textini yaz",
  "keyword": "* "
});
formatter.match({
