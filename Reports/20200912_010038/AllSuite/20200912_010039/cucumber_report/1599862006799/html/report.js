$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/Ayarlar/Gorsel Tasarimlar/Tasarim Araclari/Filtre Kontrolu.feature");
formatter.feature({
  "name": "Tasarim Araclari Filtre Kontrolu",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Filtre alanlarında Tasarım Türü var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Filtre alanlarında Değiştirilebilir var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Filtre alanlarında Oluşturma Zamanı var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Filtre alanlarında Değiştirme Zamanı var mı",
  "keyword": "* "
});
formatter.step({
