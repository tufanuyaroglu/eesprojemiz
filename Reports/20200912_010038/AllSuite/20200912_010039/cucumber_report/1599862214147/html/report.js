$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/e-Arsiv/e-Arsiv Hareketleri/e-Arsiv Faturalari/Toplu Indirme-PDF Secilenler.feature");
formatter.feature({
  "name": "e-Arsiv Toplu Indirme - PDF Secilenlerin indirilmesi",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Ön eki EArchiveInvoice olan dosya indirildi mi",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Filtrelerden Oluşturma Tarihi filtresine 01.01.2019 baslangic degerini yaz",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Filtrelerden Oluşturma Tarihi filtresine 31.01.2019 bitis degerini yaz",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Tablodan C2011 CARI ISIM isimli veri seçilir",
  "keyword": "* "
});
formatter.match({
