$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/e-Saklama/e-Arsiv/Rapor Yukleme/Rapor.feature");
formatter.feature({
...
formatter.step({
  "name": "Tablodaki \u003cveri_Adi\u003e isimli verinin Rapor adlı butonuna tıklanır",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Tablodaki envelope isimli verinin Rapor adlı butonuna tıklanır",
  "keyword": "* "
});
formatter.match({
