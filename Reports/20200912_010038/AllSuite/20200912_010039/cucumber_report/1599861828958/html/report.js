$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/Ayarlar/Gorsel Tasarimlar/Hazir Tasarim Araci/e-Arsiv/Tasarimi Indir.feature");
formatter.feature({
  "name": "e-Arsiv Hazir Tasarim Araci Tasarimi Indir",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Mavi Temalı e-Arşiv Öndeğer Şablon Tasarım 2 adlı şablonun Tasarımı İndir adlı butonuna tıkla",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Ön eki Mavi Temalı e-Arşiv Öndeğer Şablon Tasarım 2 olan dosya indirildi mi",
  "keyword": "* "
});
formatter.match({
