$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/Ayarlar/Araclar/Adres Defteri/Adres Defteri Olusturma/e-Serbest Meslek Makbuzu Adresi VKN.feature");
formatter.feature({
  "name": "VKN Ile e-Serbest Meslek Makbuzu Adresi Olusturma",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Adres defteri Kısaltma textboxına VirgosolSerbestMeslekVKN yazılır",
  "keyword": "* "
});
formatter.match({
