$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/Regresyon/e-Mustahsil Makbuz/TCKN-e-Mustahsil Makbuz Excele Aktar.feature");
formatter.feature({
...
formatter.step({
  "name": "Tabloda \u003cadı_soyadı\u003e ünvanlı veri oluşturuldu mu",
  "keyword": "* "
});
formatter.step({
  "name": "Tablodan \u003cadı_soyadı\u003e isimli veri seçilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Filtrelerden Müstahsil Ad Soyad filtresine \u003cadı_soyadı\u003e textini yaz",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Ön eki mustahsilMakbuzlari olan dosya indirildi mi",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Alıcı adı alanına VirgosolMustahsilTC girilir",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Tabloda Virgosol Otomasyon ünvanlı veri oluşturuldu mu",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Tablodan Virgosol Otomasyon isimli veri seçilir",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Filtrelerden Müstahsil Ad Soyad filtresine Virgosol Otomasyon textini yaz",
  "keyword": "* "
});
formatter.match({
