$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/Regresyon/e-Fatura/VKN-Ihracat-Istisna Excele Aktar.feature");
formatter.feature({
  "name": "VKNo ile Ihracat senaryosunda ve Istisna tipinde fatura olusturulmasi ve Excele aktarilmasi",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Senaryo alanından İhracat seçilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Ürün ekleme alanında Teslim Şartı başlığına CFR girilir",
  "keyword": "* "
});
formatter.step({
  "name": "Ürün ekleme alanında Teslim Adresi başlığına e-Fatura Test A.Ş. - 6090408038 girilir",
  "keyword": "* "
});
formatter.step({
  "name": "Ürün ekleme alanında Gönderim Şekli başlığına Havayolu girilir",
  "keyword": "* "
});
formatter.step({
  "name": "Ürün ekleme alanında Paket Türü başlığına 8C - Ahşap demet girilir",
  "keyword": "* "
});
formatter.step({
