$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/Ayarlar/Gorsel Tasarimlar/Hazir Tasarim Araci/e-Mustahsil Makbuzu/On Deger Ata.feature");
formatter.feature({
...
formatter.step({
  "name": "Popup mesajı Seçilen tasarım, e-Müstahsil Makbuzu belge türü için öndeğer tasarım olarak tanımlanacaktır. Onaylıyor musunuz içeriyor mu",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "e-Müstahsil Makbuz Öndeğer Şablon Tasarım adlı şablonun Ön Değer Ata adlı butonuna tıkla",
  "keyword": "* "
});
formatter.match({
