$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/e-Fatura/Gelen Kutusu/Faturalar/Filtre Kontrolu.feature");
formatter.feature({
  "name": "Gelen Kutusu Faturalar Filtre Kontrolu",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Filtre alanlarında Gönd. VKN/TCKN var mı",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Filtre alanlarında Okunma Durumu var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Filtre alanlarında Para Birimi var mı",
  "keyword": "* "
});
formatter.step({
