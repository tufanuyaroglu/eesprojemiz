$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/Ayarlar/Araclar/Firma Bilgileri/Firma Bilgileri.feature");
formatter.feature({
...
formatter.step({
  "name": "Alt menü Araçlar başlığı altındaki Firma Bilgileri seçilir",
  "keyword": "* "
});
formatter.step({
