$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/e-Makbuz/e-Serbest Meslek Uygulaması/e-Serbest Meslek Makbuz Raporlari/Excele Aktar.feature");
formatter.feature({
  "name": "e-Serbest Meslek Makbuz Raporlari excele aktarma",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Ön eki serbestMeslekMakbuzuRaporlar olan dosya indirildi mi",
  "keyword": "* "
});
formatter.step({
