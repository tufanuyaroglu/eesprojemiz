$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/e-Fatura/Gelen Kutusu/Uygulama Yanitlari/Gorseli Ac.feature");
formatter.feature({
  "name": "Uygulama Yanitinin Gorseli",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Tablodaki \u003cveri_Adi\u003e isimli verinin Yanıt adlı butonuna tıklanır",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Yeni sekme başlığında UYGULAMA YANITI var mı kontrol edilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Tablodaki 6090408038 isimli verinin Yanıt adlı butonuna tıklanır",
  "keyword": "* "
});
formatter.match({
