$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/e-Arsiv/e-Arsiv Hareketleri/e-Arsiv Raporlari/Buton Kontrolu.feature");
formatter.feature({
  "name": "e-Arsiv Raporlari Buton Kontrolu",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Butonlardan GİB\u0027e Gönder var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Butonlardan Yeniden Oluştur var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Butonlardan Mutabakat var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Butonlardan Rapor Oluştur var mı",
  "keyword": "* "
});
formatter.step({
