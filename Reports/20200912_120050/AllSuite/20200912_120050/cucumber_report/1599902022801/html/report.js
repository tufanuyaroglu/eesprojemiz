$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/e-Fatura/e-Fatura Araclari/e-Fatura Olusturma/As400.feature");
formatter.feature({
  "name": "e-Fatura As400",
  "description": "",
  "keyword": "Feature"
...
formatter.step({
  "name": "Filtrelerden Alıcı Ünvan filtresine \u003cfiltreDegeri\u003e textini yaz",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Butonlardan As400 isimli butona tıklanır",
  "keyword": "* "
});
formatter.step({
  ...
  "rows": [
    ...
    },
    {
      "cells": [
        "Virgosol",
        "VirgosolOtomasyon",
        "C:\\Users\\Virgosol\\Desktop\\Koc_Sistem_Giris_Bilgileri.txt"
      ]
    }
  ]
});
...
formatter.step({
  "name": "Filtrelerden Alıcı Ünvan filtresine Virgosol textini yaz",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Dosya Yükleme alanına C:\\Users\\Virgosol\\Desktop\\Koc_Sistem_Giris_Bilgileri.txt dizinindeki dosya yüklenir",
  "keyword": "* "
});
formatter.match({
