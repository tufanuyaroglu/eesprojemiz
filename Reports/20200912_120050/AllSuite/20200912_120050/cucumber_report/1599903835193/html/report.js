$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/Regresyon/e-Arsiv/VKN-Elektronik-Hal Komisyoncu Excele Aktar.feature");
formatter.feature({
  "name": "Gonderim tipi Kagit ve Hal Komisyoncu tipinde e-Arsiv faturasi olusturulmasi",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Tip alanından Hal Komisyoncu seçilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Ön Ek FFF olarak seçilir",
  "keyword": "* "
});
formatter.step({
  "name": "Tasarım alanından Mavi Temalı e-Arşiv Öndeğer Şablon Tasarım 2 seçilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Masraf Bilgileri Ekle butonuna basılır",
  "keyword": "* "
});
formatter.step({
  "name": "Masraf Bilgileri alanında Masraf Türü başlığına Komisyon girilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Filtrelerden Alıcı Ünvanı  filtresine \u003cunvan\u003e textini yaz",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Ön eki eArsivFaturalari olan dosya indirildi mi",
  "keyword": "* "
});
formatter.step({
...
formatter.match({
  "location": "genel.masrafBilgileriEkleButonunaBasilir()"
});
formatter.result({
  "status": "skipped"
});
...
formatter.match({
  "location": "genel.masrafBilgileriAlaninaGirilir(String,String)"
});
formatter.result({
  "status": "skipped"
});
...
formatter.step({
  "name": "Filtrelerden Alıcı Ünvanı  filtresine VirgosolOtomasyon textini yaz",
  "keyword": "* "
});
formatter.match({
