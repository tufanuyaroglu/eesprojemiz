$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/Regresyon/e-Irsaliye/Hal Tipi Irsaliye Excele Aktar.feature");
formatter.feature({
  "name": "TCKNo ile Hal Tipi Irsaliye senaryosunda irsaliye olusturulmasi ve Excele aktarilmasi",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Görsel tasarım sayfasının İrsaliye Bilgileri başlığını içerdiği kontrol edilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Senaryo alanından Hal Tipi İrsaliye seçilir",
  "keyword": "* "
});
formatter.step({
  "name": "Döküman Para Birimi alanından Euro seçilir",
  "keyword": "* "
});
formatter.step({
  "name": "Tasarım alanından irsaliye.xslt seçilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Farklı Teslimat Adres Tanımı adres,Türkiye,Isparta,Büyükkabaca olarak girilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Ürün ekleme alanında Malzeme Adı başlığına \u003cmalzeme_adi\u003e girilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Ürün ekleme alanında Künye Numarası başlığına 1234567890123456789 girilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Taşıyıcı Firma Bilgileri VirgosolIrsaliyeVKN olarak girilir",
  "keyword": "* "
});
formatter.step({
  "name": "Şöför Bilgileri Virgosol,Otomasyon,11111111110 olarak girilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Alıcı adı alanına VirgosolIrsaliyeVKN girilir",
  "keyword": "* "
});
formatter.match({
...
formatter.match({
  "location": "genel.farkliTeslimatAdresTanimi(String,String,String,String)"
});
formatter.result({
  "status": "skipped"
});
...
formatter.step({
  "name": "Ürün ekleme alanında Malzeme Adı başlığına Otomasyon girilir",
  "keyword": "* "
});
formatter.match({
...
formatter.match({
  "location": "genel.tasiyiciFirmaBilgileri(String)"
});
formatter.result({
  "status": "skipped"
});
...
formatter.match({
  "location": "genel.soforBilgileriGirilir(String,String,String)"
});
formatter.result({
  "status": "skipped"
});
...
formatter.step({
  "name": "Tabloda VirgosolOtomasyon11111 ünvanlı veri oluşturuldu mu",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Tablodan VirgosolOtomasyon11111 isimli veri seçilir",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Filtrelerden Alıcı Ünvan filtresine VirgosolOtomasyon11111 textini yaz",
  "keyword": "* "
});
formatter.match({
