$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/Ayarlar/Gorsel Tasarimlar/Hazir Tasarim Araci/e-Serbest Meslek Makbuzu/Tasarimi Indir.feature");
formatter.feature({
  "name": "e-Serbest Meslek Makbuzu Hazir Tasarim Araci Tasarimi Indir",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "e-Serbest Meslek Makbuz Öndeğer Şablon Tasarım adlı şablonun Tasarımı İndir adlı butonuna tıkla",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Ön eki e-Serbest Meslek Makbuz Öndeğer Şablon Tasarım olan dosya indirildi mi",
  "keyword": "* "
});
formatter.match({
