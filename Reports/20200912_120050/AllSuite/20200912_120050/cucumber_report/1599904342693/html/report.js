$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/Ayarlar/Araclar/Adres Defteri/Adres Defteri Silme/e-Irsaliye Adresi.feature");
formatter.feature({
  "name": "e-Irsaliye adresini silme",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Filtrelerden Kısaltma filtresine VirgosolIrsaliyeVKN textini yaz",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Tablodan VirgosolIrsaliyeVKN isimli veri seçilir",
  "keyword": "* "
});
formatter.match({
