$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/OKC Islemleri/OKC Mali Raporlari/Excele Aktar.feature");
formatter.feature({
  "name": "OCK Mali Raporlari Excele Aktar",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Ön eki okcRaporlari olan dosya indirildi mi",
  "keyword": "* "
});
formatter.step({
