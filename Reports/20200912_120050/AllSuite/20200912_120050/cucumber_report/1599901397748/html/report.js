$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/Ayarlar/Araclar/Ayarlarim/Baslik Kontrolu.feature");
formatter.feature({
  "name": "Ayarlarim Baslik Kontrolu",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Dinamik başlıklarda Kullanıcı Ayarları var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Dinamik başlıklarda Hesap Ayarları var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Dinamik başlıklarda Posta Kutusu Hesap Ayarları var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Dinamik başlıklarda Mail Gönderim Ayarları var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Dinamik başlıklarda Mail Gönderimi Dosya Eki Ayarları var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Dinamik başlıklarda E-Arşiv Mail Gönderim Ayarları var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Dinamik başlıklarda e-Fatura Ayarları var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Dinamik başlıklarda e-Fatura Gümrük Aracı Kurum Ayarları var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Dinamik başlıklarda Otomatik Fatura Numarası Ayarları var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Dinamik başlıklarda Web Fatura Oluşturma Varsayılan Fatura Ayarları var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Dinamik başlıklarda Web Fatura Oluşturma Varsayılan E-Arşiv Fatura Ayarları var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Dinamik başlıklarda Dosya İsimlendirme Ayarları var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Dinamik başlıklarda Earşiv Rapor Gönderim Ayarları var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Dinamik başlıklarda Web e-İrsaliye Ayarları var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Dinamik başlıklarda Web e-Müstahsil Ayarları var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Dinamik başlıklarda Web e-Serbest Meslek Makbuzu Ayarları var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Dinamik başlıklarda Güvenlik AYARI (IP Bilgisi) var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Dinamik başlıklarda Yetki Ayarları var mı",
  "keyword": "* "
});
formatter.step({
