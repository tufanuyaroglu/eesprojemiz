$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/Regresyon/e-Fatura/VKN-Temel Fatura-Sgk Excele Aktar.feature");
formatter.feature({
  "name": "VKNo ile Temel Fatura senaryosunda ve Sgk tipinde fatura olusturulmasi ve Excele aktarilmasi",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Senaryo alanından Temel Fatura seçilir",
  "keyword": "* "
});
formatter.step({
  "name": "Tip alanından Sgk seçilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "SGK Bilgileri Eczane,1111111111,Virgosol,1111111111,1.01.2020,31.01.2020 olarak girilir",
  "keyword": "* "
});
formatter.step({
...
formatter.match({
  "location": "genel.SGKBilgileriGirilir(String,String,String,String,String,String)"
});
formatter.result({
  "status": "passed"
});
...
formatter.step({
  "name": "Tabloda SOSYAL GÜVENLİK KURUMU BAŞKANLIĞI ünvanlı veri oluşturuldu mu",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Tablodan SOSYAL GÜVENLİK KURUMU BAŞKANLIĞI isimli veri seçilir",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Filtrelerden Alıcı Ünvan filtresine SOSYAL GÜVENLİK KURUMU BAŞKANLIĞI textini yaz",
  "keyword": "* "
});
formatter.match({
