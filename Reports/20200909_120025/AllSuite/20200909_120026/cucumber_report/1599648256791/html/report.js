$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/e-Makbuz/e-Serbest Meslek Uygulaması/e-Serbest Meslek Makbuz Raporlari/Gecmis.feature");
formatter.feature({
  "name": "e-Serbest Meslek Makbuz Raporlari Gecmisi",
  "description": "",
  "keyword": "Feature"
});
...
formatter.examples({
  ...
  "rows": [
    ...
    },
    {
      "cells": [
        "4",
        "Self-Employed Receipt Report - 4"
      ]
    }
  ]
});
...
formatter.step({
  "name": "Self-Employed Receipt Report - 4 baslikli gecmis sayfasi geldi mi",
  "keyword": "* "
});
formatter.match({
