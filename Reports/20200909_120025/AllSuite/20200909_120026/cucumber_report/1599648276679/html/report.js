$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/e-Makbuz/e-Serbest Meslek Uygulaması/e-Serbest Meslek Makbuz Raporlari/Rapor.feature");
formatter.feature({
  "name": "e-Serbest Meslek Makbuz Raporlari Rapor",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Filtrelerden Dönem Tarihi filtresine Hepsi dropdowndan degeri seçilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Tablodan 4 isimli veri seçilir",
  "keyword": "* "
});
formatter.match({
