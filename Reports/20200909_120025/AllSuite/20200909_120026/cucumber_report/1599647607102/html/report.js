$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/e-Makbuz/e-Mustahsil Uygulamasi/e-Mustahsil Makbuzlari/Iptal Et.feature");
formatter.feature({
  "name": "e-Mustahsil Makbuzu Iptal Et",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Butonlardan İptal Et isimli butona tıklanır",
  "keyword": "* "
});
formatter.step({
  "name": "Popup mesajı Seçilen makbuzlardan başarılı durumunda olanlar iptal edilecektir onaylıyor musunuz içeriyor mu",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Popup mesajı Başarılı durumdaki belgeler iptal edilmiştir içeriyor mu",
  "keyword": "* "
});
formatter.step({
