$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/e-Saklama/e-Arsiv/Rapor Yukleme/Yukle.feature");
formatter.feature({
  "name": "e-Arsiv Rapor Yukle",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Alt menü e-Arşiv başlığı altındaki Rapor Yükleme seçilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Tabloda deneme ünvanlı veri oluşturuldu mu",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Dosya Yükleme alanına C:\\otomasyonupfiles\\enes.zip dizinindeki dosya yüklenir",
  "keyword": "* "
});
formatter.match({
