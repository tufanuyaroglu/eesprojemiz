$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/e-Makbuz/e-Mustahsil Uygulamasi/e-Mustahsil Makbuzlari/Goruntule.feature");
formatter.feature({
  "name": "e-Mustahsil Makbuzu Goruntule",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Tablodaki \u003cveri_Adi\u003e isimli verinin Görüntüle adlı butonuna tıklanır",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Yeni sekme başlığında e-Müstahsil Makbuzu var mı kontrol edilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Tablodaki Fuat Gardrop Ltd. isimli verinin Görüntüle adlı butonuna tıklanır",
  "keyword": "* "
});
formatter.match({
