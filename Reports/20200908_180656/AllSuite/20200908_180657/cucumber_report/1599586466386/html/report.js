$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/Zarflar/Giden Zarflar/GIB.feature");
formatter.feature({
  "name": "Giden Zarf GIB",
  "description": "",
  "keyword": "Feature"
...
formatter.step({
  "name": "Butonlardan GİB isimli butona tıklanır",
  "keyword": "* "
});
formatter.step({
  "name": "GİB Durum Sorgulama popupı açıldı mı",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Tablodan GÜMRÜK VE TİCARET BAKANLIĞI isimli veri seçilir",
  "keyword": "* "
});
formatter.match({
