$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/e-Fatura/Giden Kutusu/Faturalar/Gorseli Ac.feature");
formatter.feature({
...
formatter.step({
  "name": "Tablodaki LOGO ELEKTRONİK TİCARET isimli verinin Fatura adlı butonuna tıklanır",
  "keyword": "* "
});
formatter.match({
