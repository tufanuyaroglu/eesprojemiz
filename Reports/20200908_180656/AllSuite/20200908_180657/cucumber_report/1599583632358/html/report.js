$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/e-Makbuz/e-Mustahsil Uygulamasi/e-Mustahsil Makbuzu Raporlari/Rapor.feature");
formatter.feature({
  "name": "e-Mustahsil Makbuzu Raporlari Rapor",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "e-Müstahsil Makbuzu Raporu popupı açıldı mı",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Filtrelerden Bölüm Tarihi filtresine 01.01.2020 baslangic degerini yaz",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Filtrelerden Bölüm Tarihi filtresine 31.01.2020 bitis degerini yaz",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Tablodan 917 isimli veri seçilir",
  "keyword": "* "
});
formatter.match({
