$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/Regresyon/e-Fatura/VKN-Yolcu Beraber-Istisna Excele Aktar.feature");
formatter.feature({
  "name": "VKNo ile Yolcu Beraber senaryosunda ve Istisna tipinde fatura olusturulmasi ve Excele aktarilmasi",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Senaryo alanından Yolcu Beraber seçilir",
  "keyword": "* "
});
formatter.step({
  "name": "Turist alanına TuristAd,TuristSoyad,1111111111,31.01.2020,Almanya,Türkiye girilir",
  "keyword": "* "
});
formatter.step({
...
formatter.match({
  "location": "genel.TuristBilgileriGirilir(String,String,String,String,String,String)"
});
formatter.result({
  "status": "passed"
});
