$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/Ayarlar/Gorsel Tasarimlar/Tasarim Araclari/Buton Kontrolu.feature");
formatter.feature({
  "name": "Tasarim Araclari Buton Kontrolu",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Butonlardan Tasarla var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Butonlardan Güncelle var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Butonlardan Kopyala var mı",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Alt butonlardan e-Fatura var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Alt butonlardan e-Arşiv var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Alt butonlardan e-İrsaliye var mı",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Alt butonlardan e-Müstahsil Makbuzu var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Alt butonlardan e-Serbest Meslek Makbuzu var mı",
  "keyword": "* "
});
formatter.step({
