$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/e-Makbuz/e-Serbest Meslek Uygulaması/e-Serbest Meslek Makbuzlari/Filtre Kontrolu.feature");
formatter.feature({
  "name": "e-Serbest Meslek Makbuzlari Filtre Kontrolu",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Filtre alanlarında Alıcı TCKN var mı",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Filtre alanlarında Net Ücret var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Filtre alanlarında KDV Tutarı var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Filtre alanlarında Net Alınan Toplam var mı",
  "keyword": "* "
});
formatter.step({
