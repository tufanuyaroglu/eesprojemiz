$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/Ayarlar/Gorsel Tasarimlar/Tasarim Araclari/Tasarla e-Arsiv.feature");
formatter.feature({
  "name": "Tasarim Araclari Tasarla e-Arsiv",
  "description": "",
  "keyword": "Feature"
});
formatter.scenarioOutline({
  "name": "Tasarla e-Arsiv",
  "description": "",
...
formatter.step({
  "name": "Alt butonlardan e-Arşiv butonuna tıklanır",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Yönetim popupında İptal seçilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Dinamik başlıklarda E-ARŞİV TASARIM AÇIKLAMASI var mı",
  "keyword": "* "
});
formatter.match({
