$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/Ayarlar/Gorsel Tasarimlar/Tasarim Araclari/Kopyala.feature");
formatter.feature({
  "name": "Tasarim Araclari Kopyala",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Butonlardan Kopyala isimli butona tıklanır",
  "keyword": "* "
});
formatter.step({
  "name": "Tabloda \u003cname\u003e ünvanlı veri oluşturuldu mu",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Filtrelerden Oluşturma Zamanı filtresine 01.06.2020 baslangic degerini yaz",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Filtrelerden Oluşturma Zamanı filtresine 15.06.2020 bitis degerini yaz",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Tablodaki VirgosolOtomasyon ünvanlı veriye tıklanır",
  "keyword": "* "
});
formatter.match({
