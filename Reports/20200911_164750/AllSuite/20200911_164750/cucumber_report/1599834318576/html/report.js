$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/e-Makbuz/e-Mustahsil Uygulamasi/e-Mustahsil Makbuzu Olusturma/Sil.feature");
formatter.feature({
  "name": "e-Mustahsil Makbuzu Sil",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Popup mesajı Seçilen makbuzlar silinecektir, devam etmek istiyor musunuz içeriyor mu",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Popup mesajı Seçtiğiniz makbuzlar başarıyla silinmiştr içeriyor mu",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Alıcı adı alanına VirgosolMüstahsilTC girilir",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Tabloda Virgosol ünvanlı veri oluşturuldu mu",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Tablodan Virgosol isimli veri seçilir",
  "keyword": "* "
});
formatter.match({
