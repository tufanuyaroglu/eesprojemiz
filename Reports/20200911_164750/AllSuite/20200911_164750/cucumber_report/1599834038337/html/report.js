$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/e-Irsaliye/Giden Kutusu/Irsaliyeler/Gorseli Ac.feature");
formatter.feature({
...
formatter.step({
  "name": "Tablodaki ABC A.Ş isimli verinin İrsaliye adlı butonuna tıklanır",
  "keyword": "* "
});
formatter.match({
