$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/e-Fatura/Gelen Kutusu/Uygulama Yanitlari/Filtre Kontrolu.feature");
formatter.feature({
  "name": "Gelen Kutusu Uygulama Yanitlari Filtre Kontrolu",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Alt menü Gelen Kutusu başlığı altındaki Uygulama Yanıtları seçilir",
  "keyword": "* "
});
formatter.step({
  "name": "Filtre alanlarında Gönderen VKN var mı",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Filtre alanlarında İlişkili Fatura No var mı",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Filtre alanlarında Uygulama Yanıtı No var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Filtre alanlarında İlişkili Fatura ETTN var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Filtre alanlarında Uygulama Yanıtı var mı",
  "keyword": "* "
});
formatter.step({
