$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/e-Arsiv/e-Arsiv Hareketleri/e-Arsiv Raporlari/Excele Aktar.feature");
formatter.feature({
  "name": "e-Arsiv Raporunun excele aktarilmasi",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Ön eki eArsivRaporlari olan dosya indirildi mi",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Tablodan 2675073 isimli veri seçilir",
  "keyword": "* "
});
formatter.match({
