$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/e-Makbuz/e-Serbest Meslek Uygulaması/e-Serbest Meslek Makbuzlari/Goruntule.feature");
formatter.feature({
  "name": "e-Serbest Meslek Makbuzlari Goruntule",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Yeni sekme başlığında e-Serbest Meslek Makbuzu var mı kontrol edilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Tablodaki wwww isimli verinin Görüntüle adlı butonuna tıklanır",
  "keyword": "* "
});
formatter.match({
