$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/Regresyon/e-Arsiv/VKN-Kagit-Hal Satis Excele Aktar.feature");
formatter.feature({
  "name": "Gonderim tipi Kagit ve Hal Satis tipinde e-Arsiv faturasi olusturulmasi",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Gönderim Şekli Kağıt olarak seçilir",
  "keyword": "* "
});
formatter.step({
  "name": "Tip alanından Hal Satış seçilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Ürün ekleme alanında Vkn/Tckn başlığına 24647325036 girilir",
  "keyword": "* "
});
formatter.step({
  "name": "Ürün ekleme alanında Mal Sahibi başlığına AAAAAAAAA girilir",
  "keyword": "* "
});
formatter.step({
