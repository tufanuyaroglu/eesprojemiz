$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/Ayarlar/Gorsel Tasarimlar/Hazir Tasarim Araci/e-Arsiv/On Deger Ata.feature");
formatter.feature({
...
formatter.step({
  "name": "Popup mesajı Seçilen tasarım, e-Arşiv belge türü için öndeğer tasarım olarak tanımlanacaktır. Onaylıyor musunuz içeriyor mu",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Mavi Temalı e-Arşiv Öndeğer Şablon Tasarım 2 adlı şablonun Ön Değer Ata adlı butonuna tıkla",
  "keyword": "* "
});
formatter.match({
