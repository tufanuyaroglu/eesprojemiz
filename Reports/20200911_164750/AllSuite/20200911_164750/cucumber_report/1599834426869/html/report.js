$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/e-Makbuz/e-Serbest Meslek Uygulaması/e-Serbest Meslek Makbuz Raporlari/Tumunu Excel Aktar.feature");
formatter.feature({
  "name": "e-Serbest Meslek Makbuz Raporlari tumunu excele aktarma",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Tablodan 1701 isimli veri seçilir",
  "keyword": "* "
});
formatter.match({
