$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/Ayarlar/Araclar/Adres Defteri/Adres Defteri Silme/e-Serbest Meslek Adresi.feature");
formatter.feature({
  "name": "e-Serbest Meslek adresini silme",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Filtrelerden Kısaltma filtresine \u003ckisaltma_deger\u003e textini yaz",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Tablodan \u003ckisaltma_deger\u003e isimli veri seçilir",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Popup mesajı Seçilen kayıtlar silinecektir. Devam etmek istiyor musunuz içeriyor mu",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Popup mesajı Seçilen kayıtlar silinmiştir içeriyor mu",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Filtrelerden Kısaltma filtresine VirgosolSerbestMeslekVKN textini yaz",
  "keyword": "* "
});
formatter.match({
...
formatter.step({
  "name": "Tablodan VirgosolSerbestMeslekVKN isimli veri seçilir",
  "keyword": "* "
});
formatter.match({
