$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/Ayarlar/Gorsel Tasarimlar/Hazir Tasarim Araci/e-Arsiv/Buton Kontrolu.feature");
formatter.feature({
  "name": "e-Arsiv Hazir Tasarim Araci On Deger Ata",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Mavi Temalı e-Arşiv Öndeğer Şablon Tasarım 2 adlı şablonun Tasarımı İndir adlı butonu var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Mavi Temalı e-Arşiv Öndeğer Şablon Tasarım 2 adlı şablonun Önizleme adlı butonu var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Mavi Temalı e-Arşiv Öndeğer Şablon Tasarım 2 adlı şablonun Ön Değer Ata adlı butonu var mı",
  "keyword": "* "
});
formatter.step({
  "name": "e-Arşiv Öndeğer Şablon Tasarım adlı şablonun Tasarımı İndir adlı butonu var mı",
  "keyword": "* "
});
formatter.step({
  "name": "e-Arşiv Öndeğer Şablon Tasarım adlı şablonun Önizleme adlı butonu var mı",
  "keyword": "* "
});
formatter.step({
  "name": "e-Arşiv Öndeğer Şablon Tasarım adlı şablonun Ön Değer Ata adlı butonu var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Mavi Temalı e-Arşiv Öndeğer Şablon Tasarım adlı şablonun Tasarımı İndir adlı butonu var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Mavi Temalı e-Arşiv Öndeğer Şablon Tasarım adlı şablonun Önizleme adlı butonu var mı",
  "keyword": "* "
});
formatter.step({
  "name": "Mavi Temalı e-Arşiv Öndeğer Şablon Tasarım adlı şablonun Ön Değer Ata adlı butonu var mı",
  "keyword": "* "
});
formatter.step({
