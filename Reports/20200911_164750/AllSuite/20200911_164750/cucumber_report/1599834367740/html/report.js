$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/e-Makbuz/e-Mustahsil Uygulamasi/e-Mustahsil Makbuzu Raporlari/Tumunu Excele Aktar.feature");
formatter.feature({
  "name": "e-Mustahsil Makbuzu Raporlari tumunu excele aktarma",
  "description": "",
  "keyword": "Feature"
});
