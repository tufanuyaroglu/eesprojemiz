$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/otomasyonprojeler/EES/Include/features/Ayarlar/Gorsel Tasarimlar/Tasarim Araclari/Guncelle.feature");
formatter.feature({
  "name": "Tasarim Araclari Guncelle",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "Butonlardan Güncelle isimli butona tıklanır",
  "keyword": "* "
});
formatter.step({
...
formatter.step({
  "name": "Butonlardan Farklı Kaydet isimli butona tıklanır",
  "keyword": "* "
});
formatter.step({
