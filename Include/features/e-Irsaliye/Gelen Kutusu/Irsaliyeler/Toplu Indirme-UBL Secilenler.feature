Feature: e-Irsaliye Gelen Kutusu Toplu Indirme - UBL Secilenlerin indirilmesi

  Scenario Outline: e-Irsaliye Gelen Kutusu Toplu Indirme - UBL Secilenlerin indirilmesi
    * Giriş yapılır
