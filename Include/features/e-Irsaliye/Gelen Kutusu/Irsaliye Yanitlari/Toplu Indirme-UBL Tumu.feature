Feature: e-Irsaliye Gelen Kutusu Uygulama Yanıtları Toplu Indirme - UBL Tumunun indirilmesi

  Scenario Outline: e-Irsaliye Gelen Kutusu Uygulama Yanıtları Toplu Indirme - UBL Tumunun indirilmesi
    * Giriş yapılır
