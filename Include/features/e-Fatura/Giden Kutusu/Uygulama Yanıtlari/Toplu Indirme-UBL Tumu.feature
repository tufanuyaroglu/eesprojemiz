Feature: e-Fatura Giden Kutusu Uygulama Yanıtları Toplu Indirme - UBL Tumunun indirilmesi

  Scenario Outline: e-Fatura Giden Kutusu Uygulama Yanıtları Toplu Indirme - UBL Tumunun indirilmesi
    * Giriş yapılır
