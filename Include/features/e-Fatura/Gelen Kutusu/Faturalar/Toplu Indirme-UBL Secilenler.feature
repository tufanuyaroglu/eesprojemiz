Feature: e-Fatura Gelen Kutusu Toplu Indirme - UBL Secilenlerin indirilmesi

  Scenario Outline: e-Fatura Gelen Kutusu Toplu Indirme - UBL Secilenlerin indirilmesi
    * Giriş yapılır
