Feature: e-Fatura Gelen Kutusu Uygulama Yanıtları Toplu Indirme - UBL Tumunun indirilmesi

  Scenario Outline: e-Fatura Gelen Kutusu Uygulama Yanıtları Toplu Indirme - UBL Tumunun indirilmesi
    * Giriş yapılır
